...
export IMAGE_URL=${IMAGE_URL-tssc-quay-quay-tssc-quay.apps.cluster-2jqtd.2jqtd.sandbox1734.opentlc.com/rhtap-test-organization-jk/rhtap-qe-java-quarkus:$CI_TYPE-$TAG}
...
export ROX_CENTRAL_ENDPOINT=central-tssc-acs.apps.cluster-2jqtd.2jqtd.sandbox1734.opentlc.com:443
...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/kkqkp87un-java-quarkus-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-tssc-tas.apps.cluster-2jqtd.2jqtd.sandbox1734.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-tssc-tas.apps.cluster-2jqtd.2jqtd.sandbox1734.opentlc.com}
...
export COSIGN_PUBLIC_KEY=LS0tLS1CRUdJTiBQVUJMSUMgS0VZLS0tLS0KTUZrd0V3WUhLb1pJemowQ0FRWUlLb1pJemowREFRY0RRZ0FFaDB1bHR4dTllL2hVWEhMekNDd2c5UEsxR09tMApsaW1SSHRQZXYwWjNLQ3l0UngvUGk3WVFlQk9Za1IzRzhoMzZnNFNsRldaeTVVWWhDNk5vT01rVTB3PT0KLS0tLS1FTkQgUFVCTElDIEtFWS0tLS0tCg==
